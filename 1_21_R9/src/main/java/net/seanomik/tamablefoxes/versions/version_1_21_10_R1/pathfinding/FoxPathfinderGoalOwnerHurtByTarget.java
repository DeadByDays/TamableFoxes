package net.seanomik.tamablefoxes.versions.version_1_21_10_R1.pathfinding;

import net.minecraft.world.entity.LivingEntity;
import net.minecraft.world.entity.ai.goal.target.TargetGoal;
import net.minecraft.world.entity.ai.targeting.TargetingConditions;
import net.seanomik.tamablefoxes.versions.version_1_21_10_R1.EntityTamableFox;
import net.seanomik.tamablefoxes.versions.version_1_21_10_R1.NMSUtil;
